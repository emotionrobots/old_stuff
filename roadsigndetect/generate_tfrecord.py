...
def class_text_to_int(row_label):
    if row_label == 'merge':
        ...
        return 6
    elif row_label == 'schoolSpeedLimit25':
        return 7
        ...
        return 14
    elif row_label == 'speedLimitUrdbl':
        return 15
    else:
        print("Retunredclass")
        print(row_label)
...
def main(_):
    writer = tf.python_io.TFRecordWriter("/home/raj/Desktop/roadsigndetect/data/test.record")
    path = os.path.join(os.getcwd(), 'images')
    examples = pd.read_csv("/home/raj/Desktop/roadsigndetect/data/test_labels.csv")
